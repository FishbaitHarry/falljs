...
describe('Scope with async factories', function() {
    beforeEach(function() {
        this.scope = falljs.createScope();

        function factory1() {return Promise.resolve('product1-instance');}
        factory1.produces = 'product1-uri';
        factory1.inject = {};
        this.scope.register(factory1);

        function factory2() {return Promise.resolve('product2-instance');}
